    ...
    <div class="container mx-auto px-6 py-3">
        ...
        <nav class="sm:flex sm:justify-center sm:items-center mt-4">
            <div class="flex flex-col sm:flex-row">
                <router-link to="/" class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0">Home</router-link>
                <router-link to="/about" class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0">About</router-link>
            </div>
        </nav>
